...
MODELS = {
    ...
    'decisiontree_classifier': tree.DecisionTreeClassifier(criterion='gini', splitter='best', max_depth=None,
                                                           ...
                                                           presort='deprecated',
                                                           ccp_alpha=0.0),
    "randomforest_classifier": ensemble.RandomForestClassifier(n_estimators=200, criterion='gini', max_depth=None, min_samples_split=3,
    ...
    "logistic_regression": linear_model.LogisticRegression(n_jobs=n_jobs, max_iter=200, verbose=1),
